...
export async function resumenDe(fecha: DiaISO): Promise<ResumenDia> {
  ...
  return {
     ...
     */
    restantePollos: jornada.stockPollos - repartidoPollos - repartidoPechos,
    restantePiernas: jornada.stockPiernas + repartidoPechos - repartidoPiernas,
